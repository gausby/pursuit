...
var dictionary = {
    ...
    /**
     * Test if the given value is less or equal to the input
     *
    ...
    endsWith: function (key, value) {
        ...
        rtn += 'entry['+key+'].substr(-'+(value.length-2)+') === '+value;
