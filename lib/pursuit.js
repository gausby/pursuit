...
function Pursuit (query) {
    ...
    if (typeof localScope.optimize !== 'boolean') {
        localScope.optimize = true;
    }
    ...
    localScope.call = function (key, value) {
        var obj = {};
        obj[key] = value;
        return dictionaryLookUp.call(localScope, obj, key, this.key);
    };
